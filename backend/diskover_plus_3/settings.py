"""
Django settings for diskover_plus_3 project.
...
# The secret key is used for cryptographic signing and should be kept secret in production.
...
ROOT_DIR = os.path.dirname(BASE_DIR)  # parent of backend/
...
WSGI_APPLICATION = 'diskover_plus_3.wsgi.application'
...
# For production, to serve static files
STATIC_ROOT = os.path.join(BASE_DIR, 'static')

STATIC_URL = '/static/'

# For development, to serve static files
# STATICFILES_DIRS = [
